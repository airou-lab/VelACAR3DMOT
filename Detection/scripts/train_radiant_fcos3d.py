...
def main(args):
    ...
    if args.dir_data == None:
        this_dir = os.path.dirname(__file__)
        args.dir_data = join('data', 'nuscenes')
        
    if args.path_checkpoint_fcos3d == None:
        this_dir = os.path.dirname(__file__)
        args.path_checkpoint_fcos3d = join('checkpoints', 'fcos3d_r101_caffe_fpn_gn-head_dcn_2x8_1x_nus-mono3d_finetune_20210717_095645-8d806dc2.pth')        
