...
do
    ...
    python workfile.py --concat --detection_method Radiant
...
#     # saving output
#     mv output/track_output_Radiant output/Radiant_hyper_exp/thresh/$thresh
# done
...
#     # saving output
#     mv output/track_output_Radiant output/Radiant_hyper_exp/min_hits/$min_hit
# done
...
#     # saving output
#     mv output/track_output_Radiant output/Radiant_hyper_exp/max_age/$max_age
# done
...
# # With velocity
# # CR3DMOT tracking pipeline
# python workfile.py --data_root ./data/nuScenes --cat_detection_root ./data/cat_detection/ --split val --use_R --detection_method Radiant --score_thresh 0.1 
...
# # saving output
# mv output/track_output_Radiant output/Radiant_vel_exp/with_vel
...
# # saving output
# mv output/track_output_Radiant output/Radiant_vel_exp/no_vel
