...
'''
From Hsu-kuang Chiu : Probabilistic 3D Multi-Object Tracking for Autonomous Driving
URL : https://github.com/eddyhkchiu/mahalanobis_3d_multi_object_trackin
'''
...
class Covariance(object):
  ...
  def __init__(self, covariance_id):
    ...
    if covariance_id == 0:
      ...
      # see get_nuscenes_stats.py for the details on  how the numbers come from
      # Kalman Filter state: [x, y, z, rot_z, l, w, h, x_dot, y_dot, z_dot, rot_z_dot]
      # adding velocity uncertainty to measurement noise (R) 
